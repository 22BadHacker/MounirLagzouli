...
let links = document.getElementById('menu-item');
let getDev = document.getElementById('getDev');
let getDesign = document.getElementById('getDesign');
let hide = document.getElementById('hide');

let dev = document.querySelectorAll('.dev');
let design = document.querySelectorAll('.design');

getDev.addEventListener('click', () => {
    hide.remove();
})
